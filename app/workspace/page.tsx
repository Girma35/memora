			...
			<div className="flex flex-1 w-full max-w-6xl mx-auto mt-8 px-6 gap-12">
				...
				<main className="flex-1 pb-24">
					...
					<div className="flex items-center justify-between mb-8">
						...
						<Button
							variant="outline"
							className="rounded-full border-white/10 bg-transparent hover:bg-white/5 text-zinc-300 px-5"
						>
					...
					<div className="rounded-2xl border border-white/5 bg-[#141414] p-12 flex flex-col items-center justify-center mb-6 relative overflow-hidden">
						...
						<div
							className="text-[120px] font-bold text-white leading-none tracking-tighter mb-4 z-10"
						...
						<div className="rounded-2xl border border-white/5 bg-[#141414] p-6">
							...
							<div className="flex flex-wrap gap-2">
								<Button
									variant="outline"
									size="sm"
									className="bg-[#1A1A1A] border-white/5 hover:bg-white/10 hover:border-white/10 text-zinc-300 text-xs font-normal h-8"
								>
								...
								<Button
									...
									className="bg-[#1A1A1A] border-white/5 hover:bg-white/10 hover:border-white/10 text-zinc-300 text-xs font-normal h-8"
								>
									<Code2 className="size-3.5 mr-2 text-[#00E5FF]" />{" "}
									middleware.ts
								</Button>
								<Button
									variant="outline"
									...
									className="bg-[#1A1A1A] border-white/5 hover:bg-white/10 hover:border-white/10 text-zinc-300 text-xs font-normal h-8"
								>
									<FileText className="size-3.5 mr-2 text-zinc-400" /> Next.js
									Middleware Docs
								</Button>
								<Button
									variant="outline"
									...
									className="bg-[#1A1A1A] border-white/5 hover:bg-white/10 hover:border-white/10 text-zinc-300 text-xs font-normal h-8"
								>
									<Search className="size-3.5 mr-2 text-zinc-400" /> JWT vs
									Session cookie research
								</Button>
							</div>
						</div>
					</div>
